...
public interface UserService {
    ...
    void updateNicknameAndUserProfile(String nickname,String user_profile,String username);

    List<User> queryByUsername(String username);

    void insertTemp(String from_id,String to_id);

    List<User> getAllRequest(String to_id);

    void deleteAddUser(String from_id,String to_id);
    void addRelation(String user_id,String friend_id);

    List<User> getNewFriends(String username);
